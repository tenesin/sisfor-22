        ...
        <div className="container mx-auto flex justify-between">
          <div>
            <span className="block text-sm text-white sm:text-left">
              ...
              <Link href="../team" className="hover:underline text-light-blue-sisfor">
                Webdev Team 2022
              </Link>
            </span>
          ...
          <Link href="https://www.instagram.com/sisforits22/" target="_blank" className="hover:underline text-light-blue-sisfor">
